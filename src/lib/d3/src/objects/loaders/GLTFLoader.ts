 ...
 */
	...
	class GLTFLoader extends THREE.Loader {
		...
		parse(data, path, onLoad, onError) {
			...
			const parser:any = new GLTFParser(json, {
 ...
 */
	...
	class GLTFMaterialsPbrSpecularGlossinessExtension {
		...
		createMaterial(materialParams) {
			...
			const material:any = new GLTFMeshStandardSGMaterial(materialParams);
			material.fog = true;
 ...
 */
	...
	class GLTFParser {
		...
		constructor(json = {}, options = {}) {
			...
			this.cache = GLTFRegistry(); // associations between Three.js objects and glTF elements
